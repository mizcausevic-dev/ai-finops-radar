...
### Released
- Shipped **ai-finops-radar** as a public artifact for teams dealing with event-driven revenue systems.
...
### Shipped
- Cut the first coherent internal version of **ai-finops-radar** with stable domain objects, review surfaces, and decision outputs.
